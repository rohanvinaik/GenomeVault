...
try:
    ...
    # Create test variant
    variant = {"chr": "chr1", "pos": 12345, "ref": "A", "alt": "G"}
...
try:
    ...
    print("  ✅ Single proof generated successfully")
    print("  ✅ Hash was corrected during generation")
...
try:
    ...
    tasks = []
    for i in range(3):
        variant_data = {"chr": f"chr{(i%22)+1}", "pos": i * 1000 + 12345, "ref": "A", "alt": "G"}
