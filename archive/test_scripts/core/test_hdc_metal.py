...
def test_hdc_with_metal():
    ...
    test_data = {"sample_id": "TEST_HDC_001", "variants": {}}
    ...
    if metrics.compressed_size <= CompressionTier.FULL_HDC.target_bytes:
        print("  ✅ Met target size!")
    else:
        print(
            f"  ⚠️  Exceeded target by {metrics.compressed_size - CompressionTier.FULL_HDC.target_bytes:,} bytes"
        )
