...
is_valid = prover.verify_proof(
    proof=proof, public_inputs=public_inputs, circuit_name="variant_presence"
)
...
is_valid2 = prover.verify_proof(proof=proof, public_inputs=public_inputs)
...
is_valid3 = prover.verify_proof(
    proof=proof, public_inputs=wrong_inputs, circuit_name="variant_presence"
)
