...
def test_transcript_fallback():
    ...
    if proof:
        ...
        if proof.proof.get("engine") == "transcript":
            print("   ✓ Transcript engine confirmed")
        ...
        is_invalid = engine.verify_proof(valid_proof.proof, wrong_public, circuit_type="sum64")
        ...
        if custom_proof:
            ...
            is_valid_custom = engine.verify_proof(
                custom_proof.proof, custom_proof.public, circuit_type="custom_circuit"
            )
