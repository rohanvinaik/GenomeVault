...
- **Computationally efficient:** 21.67ms encoding time, 178× faster than traditional pipelines
...
![Hypervector Encoding Performance](paper_figures/figure3_hypervector_encoding.pdf){ width=100% }
...
3. **MLX (Apple Silicon):** Metal acceleration, 21.67ms encoding time
...
|----------|----------|---------------|------------|-------------------|
| **MLX (Recommended)** | Apple M1 Max | **21.67ms** | **46 genomes/sec** | **264×** |
...
- **Compression: 40MB → 155KB = 2,640× → 1 = 264× effective**
...
|--------|----------------|--------------|-------------------|---------------|
| **GenomeVault (HDC)** | **21.67ms** | **1KB** | **Cryptographic** | **0%** |
...
|-----------|---------|---------|
| 1. HDC Encoding | 21.67ms | 400K variants → 8,192D vector |
...
![End-to-End Pipeline Performance](paper_figures/figure4_end_to_end_performance.pdf){ width=100% }
...
![Differential Encoding System Overview](paper_figures/figure1_differential_encoding_overview.pdf){ width=100% }
...
![Adaptive Chunking Strategies](paper_figures/figure2_chunking_strategies.pdf){ width=100% }
...
|--------|-----------------|---------|---------|
| **GenomeVault** | **21.67ms** | **1KB** | **Cryptographic** |
...
- **178× faster** than traditional pipelines (21.67ms vs 266ms)
- **264× compression** (40MB → 155KB)
...
3. **Computational efficiency:** 21.67ms encoding enables real-time applications
...
- GenomeVault: Encode on-device (21.67ms), query global knowledge (<2s)
...
2. **Real-time performance** (21.67ms encoding, 1.22s end-to-end queries) — 178× faster than traditional genomic pipelines
