...
**Generated:** 2025-10-19T20:04:40.788670
...
- **Encoding Performance:** 1.49 ms per genome
- **Compression Ratio:** 2116:1
- **Final Size:** 150 KB per genome
- **Throughput:** 446580 genomes/hour
...
| Metric | Value |
|--------|-------|
| MLX Acceleration | 1.49 ms |
| CPU Baseline | 22.1 ms |
| Speedup | 14.8× |
| Compression Ratio | 2116:1 |
...
- **Per-Genome Processing:** 8.07 ms
- **Hourly Throughput:** 446580 genomes
- **Daily Capacity:** ~10,717,920 genomes
...
**Report Generated:** 2025-10-19T20:04:40.788670
