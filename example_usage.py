...
async def demonstrate_genomevault():
    ...
    print(f"Storage required: {config.get_compression_size(['genomics', 'clinical', 'transcriptomics'])} KB")
    print(f"Security level: 256-bit post-quantum")
    
    # Privacy calculations
    print("\n=== Privacy Guarantees ===")
    print(f"PIR privacy (2 TS): P_fail = {pir_client.calculate_privacy_failure_probability(2, 0.98):.2e}")
