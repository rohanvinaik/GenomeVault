...
def train_with_proof_of_training():
    ...
    for epoch in range(n_epochs):
        ...
        print(f"Epoch {epoch + 1}/{n_epochs}: Loss={avg_epoch_loss:.4f}, Val Acc={val_accuracy:.3f}")
    ...
    for i in range(100):
        ...
        if monitoring_result["alerts"]:
            print(f"  ⚠️  Drift alert at prediction {i}: {monitoring_result['alerts'][0]['drift_type']}")
