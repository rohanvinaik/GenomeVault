...
async def websocket_endpoint(websocket: WebSocket, token: str = None, user_id: str = None):
    """
    ...
    try:
        ...
        connection_id = await connection_manager.connect(
            websocket=websocket, user_id=authenticated_user_id, client_info=client_info
        )
