...
class GenomicInputSanitizer:
    ...
    VALID_CHROMOSOMES = {
        ...
        'X', 'Y', 'MT', 'M', 'chr1', 'chr2', 'chr3', 'chr4', 'chr5',
        'chr6', 'chr7', 'chr8', 'chr9', 'chr10', 'chr11', 'chr12',
        'chr13', 'chr14', 'chr15', 'chr16', 'chr17', 'chr18', 'chr19',
        'chr20', 'chr21', 'chr22', 'chrX', 'chrY', 'chrMT', 'chrM'
    }
...
class InputSanitizer:
    ...
    def sanitize_json(self, data: Dict[str, Any], field_types: Dict[str, DataType]) -> Dict[str, Any]:
...
class InputSanitizationMiddleware(BaseHTTPMiddleware):
    ...
    ENDPOINT_FIELD_TYPES = {
        ...
        '/api/pir/query': {
            'database_id': DataType.TEXT,
            'query_index': DataType.NUMERIC
        },
        '/api/clinical/': {
