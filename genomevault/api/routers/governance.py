...
from genomevault.governance.audit.events import record_event, list_events
...
def consent_grant(payload):
    ...
    record_event("consent_granted", payload.subject_id, payload.scope, {"ttl_days": payload.ttl_days})
