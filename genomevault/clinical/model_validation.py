...
class ClinicalModelValidator:
    ...
    def validate_model(
        ...
        logger.info(
            f"Clinical validation {validation_id} completed: "
    ...
    def issue_capability_attestation(
        ...
        validation_level = min(r.validation_level for r in validation_results,
    ...
    def _check_validation_criteria(
        ...
        if validation_level in [ValidationLevel.CLINICAL_DECISION_SUPPORT,
    ...
    def _determine_regulatory_standards(
        ...
        if any(d in [ClinicalDomain.ONCOLOGY, ClinicalDomain.RARE_DISEASE]
