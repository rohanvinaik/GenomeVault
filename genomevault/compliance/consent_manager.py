...
active_consents = Gauge(
    'genomevault_active_consents',
    'Current number of active consents',
...
class ConsentRecord:
    ...
    def allows_data_sharing(self, partner: str) -> bool:
        ...
        if ConsentType.SHARING not in [self.consent_type] and ConsentPurpose.CARE_COORDINATION not in self.purposes:
            return False
...
class ConsentTemplate:
    ...
    def generate_form(self, user_id: str, language: str = "en") -> Dict[str, Any]:
        ...
        return {
            ...
            "expiry_info": f"This consent expires in {self.default_expiry_days} days" if self.default_expiry_days else None
        }
...
class ConsentManager:
    ...
    def grant_consent(self,
        ...
        consent = ConsentRecord(
            ...
            specific_permissions={perm: perm in granted_permissions for perm in (template.required_permissions + template.optional_permissions)},
        ...
        consent.add_audit_entry("consent_granted", {
    ...
    def withdraw_consent(self,
        ...
        consent.add_audit_entry("consent_withdrawn", {
    ...
    def withdraw_all_consents(self,
                             user_id: str,
                             withdrawal_reason: str = "user_request") -> List[str]:
    ...
    def renew_consent(self,
                     user_id: str,
                     consent_id: str,
                     new_expiry_days: int) -> bool:
        ...
        consent.add_audit_entry("consent_renewed", {
    ...
    def expire_consents(self) -> List[str]:
        ...
        for consent_id, consent in self.consents.items():
            if consent.status == ConsentStatus.ACTIVE and consent.is_expired():
                ...
                consent.add_audit_entry("consent_expired", {
    ...
    def validate_data_use(self,
        ...
        return {
            ...
            "partner_approved": partner is None or any(c.allows_data_sharing(partner) for c in applicable_consents)
        }
