...
__all__ = [
    "GenomeVaultError", "ConfigurationError", "ValidationError", "ProjectionError", "EncodingError",
    "ZKProofError", "PIRProtocolError", "LedgerError", "FederatedError", "APISchemaError",
]
