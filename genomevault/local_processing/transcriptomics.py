...
class TranscriptomicsProcessor:
    ...
    def _process_fastq(
        ...
        gene_ids = (
            ...
            else [f"ENSG{i:011d}" for i in range(1, 1001)]
        )
    ...
    def batch_effect_correction(
        self, profiles: List[ExpressionProfile], batch_labels: List[str], method: str = "combat"
    ...
    def differential_expression(
        ...
        logger.info(
            f"Found {results_df['significant'].sum()} significantly differentially expressed genes"
        )
