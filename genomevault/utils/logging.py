...
DETAILED_FORMAT = "%(asctime)s | %(levelname)-8s | %(name)-20s | %(funcName)s:%(lineno)d | %(message)s"
...
def configure_logging(
    ...
    config_logger.info(f"Logging configured: level={logging.getLevelName(level)}, file_logging={enable_file_logging}")
