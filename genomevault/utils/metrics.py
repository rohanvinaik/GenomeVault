...
class MetricsCollector:
    ...
    def record_duration(self, metric_name: str, start_time: float, 
                       unit: str = "ms", tags: Optional[Dict[str, str]] = None):
        """
...
class MetricsContext:
    ...
    def __init__(self, metric_name: str, unit: str = "ms", 
                 tags: Optional[Dict[str, str]] = None):
        """
