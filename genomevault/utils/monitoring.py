...
class MetricsCollector:
    ...
    def __init__(self):
        ...
        self.proof_size_bytes = Histogram(
            "genomevault_proof_size_bytes", "Size of generated proofs in bytes", ["circuit_type"]
        )
        ...
        self.pir_privacy_failure_prob = Gauge(
            "genomevault_pir_privacy_failure_probability", "Current PIR privacy failure probability"
        )

        self.pir_server_honesty = Gauge(
            "genomevault_pir_server_honesty_score", "Server honesty probability", ["server_type"]
        )
        ...
        self.storage_tier_usage = Gauge(
            "genomevault_storage_tier_bytes", "Storage usage by compression tier", ["tier"]
        )
        ...
        self.active_connections = Gauge(
            "genomevault_active_connections", "Number of active connections", ["connection_type"]
        )
            ...
            def wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    self.processing_errors.labels(
                        operation=operation, data_type=data_type, error_type=type(e).__name__
                    ).inc()
