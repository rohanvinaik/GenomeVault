...
class ConstraintSystem:
    ...
    def enforce_equal(self, a: Union[Variable, LinearCombination, int, FieldElement], 
    ...
    def enforce_multiplication(self, a: Union[Variable, LinearCombination], 
...
def create_merkle_proof(leaf: FieldElement, path: List[FieldElement], 
                       indices: List[int]) -> FieldElement:
    """
