...
from genomevault.zk_proofs.circuits.multi_modal_training_proof import (
    MultiModalTrainingProof, ModalityMetrics, CrossModalAlignment
)
...
class TestMultiModalTrainingProof:
    ...
    def test_multi_modal_setup(self, multi_modal_data):
        ...
        circuit.setup(
            multi_modal_data["public_inputs"],
            multi_modal_data["private_inputs"]
        )
    ...
    def test_attention_weight_validation(self, multi_modal_data):
        ...
        multi_modal_data["private_inputs"]["cross_modal_alignments"][0]["attention_weights"] = [0.8, 0.4]
