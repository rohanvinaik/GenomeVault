...
class PerformanceDashboard:
    ...
    def render_latency_graph(self, data: Dict[str, Any]) -> List[str]:
        ...
        witness_metrics = [
            ...
            if m['operation'] == 'witness' and m['success']
        ]
...
<body>
    <div class="container">
        ...
        <div class="stats-grid">
            <div class="stat-box">
                <div class="stat-value">""" + f"{data['summary']['total_operations']:,}" + """</div>
                <div class="stat-label">Total Operations</div>
            </div>
            <div class="stat-box">
                <div class="stat-value">""" + f"{data['summary']['success_rate']:.1%}" + """</div>
                <div class="stat-label">Success Rate</div>
            </div>
            <div class="stat-box">
                <div class="stat-value">""" + f"{data['summary']['overall_cache_hit_rate']:.1%}" + """</div>
                <div class="stat-label">Cache Hit Rate</div>
            </div>
            <div class="stat-box">
                <div class="stat-value">""" + f"{data['summary']['active_alerts']}" + """</div>
        ...
        <script>
            ...
            const chart = new Chart(ctx, {
                type: 'line',
                data: {
                    labels: [""" + ','.join([f"'{i}'" for i in range(20)]) + """],
                    datasets: [{
                        label: 'Witness Latency (ms)',
                        data: [""" + ','.join([str(m['duration_ms']) for m in data['recent_metrics'][-20:] if m['operation'] == 'witness']) + """],
                        borderColor: '#00ff00',
...
def run_dashboard(mode: str = "terminal", duration: Optional[int] = None):
    ...
    if mode == "terminal":
        ...
        dashboard.save_html()
        print(f"HTML dashboard saved to zk_dashboard.html")
