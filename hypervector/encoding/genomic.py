...
from core.exceptions import HypervectorError
...
class GenomicEncoder:
    ...
    def _generate_position_vector(self) -> torch.Tensor:
        ...
        div_term = torch.exp(torch.arange(0, self.dimension, 2).float() * 
    ...
    def encode_variant(self, 
                      chromosome: str,
                      position: int,
                      ref: str,
                      alt: str,
                      variant_type: str = 'SNP') -> torch.Tensor:
        """
