...
class HypervectorBinder:
    ...
    def bind(self, 
             vec1: torch.Tensor, 
             vec2: torch.Tensor,
             operation: BindingOperation = BindingOperation.CIRCULAR_CONVOLUTION) -> torch.Tensor:
        """
    ...
    def multi_bind(self, vectors: List[torch.Tensor], 
                   operation: BindingOperation = BindingOperation.CIRCULAR_CONVOLUTION) -> torch.Tensor:
        """
    ...
    def protect_binding(self, vec1: torch.Tensor, vec2: torch.Tensor, 
...
class MultiModalBinder:
    ...
    def cross_modal_similarity(self, vec1: torch.Tensor, modality1: str,
                              vec2: torch.Tensor, modality2: str) -> float:
        """
