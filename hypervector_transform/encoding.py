...
class HypervectorEncoder:
    ...
    def encode(self, features: Union[np.ndarray, torch.Tensor, Dict],
               omics_type: OmicsType,
               resolution: str = "base") -> torch.Tensor:
        """
    ...
    def encode_multiresolution(self, features: Union[np.ndarray, torch.Tensor, Dict],
                              omics_type: OmicsType) -> Dict[str, torch.Tensor]:
        """
    ...
    def _get_projection_matrix(self, input_dim: int, output_dim: int,
                              omics_type: OmicsType) -> torch.Tensor:
    ...
    def similarity(self, hv1: torch.Tensor, hv2: torch.Tensor,
    ...
    def get_projection_stats(self) -> Dict:
        ...
        stats = {
            ...
            "memory_mb": sum(m.element_size() * m.numel() / 1024**2 
...
def create_encoder(dimension: int = 10000,
                  projection_type: str = "sparse_random",
                  **kwargs) -> HypervectorEncoder:
