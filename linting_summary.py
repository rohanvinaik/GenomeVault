...
def main():
    ...
    returncode, stdout, stderr = run_command(
        "cd /Users/rohanvinaik/genomevault && /Users/rohanvinaik/miniconda3/bin/black --check . 2>&1"
    )
    ...
    if returncode == 0:
        ...
        print(
            f"❌ FAILED - {would_reformat} files need reformatting, {failed_reformat} files have syntax errors"
        )
    ...
    print("-" * 30)
    returncode, stdout, stderr = run_command(
        "cd /Users/rohanvinaik/genomevault && /Users/rohanvinaik/miniconda3/bin/isort --check-only --quiet . 2>&1"
    )
    ...
    print("-" * 30)
    returncode, stdout, stderr = run_command(
        "cd /Users/rohanvinaik/genomevault && /Users/rohanvinaik/miniconda3/bin/flake8 genomevault/ tests/ examples/ --count 2>&1"
    )
    ...
    print("-" * 30)
    returncode, stdout, stderr = run_command(
        "cd /Users/rohanvinaik/genomevault && /Users/rohanvinaik/miniconda3/bin/pylint genomevault/ --exit-zero 2>&1 | grep 'Your code has been rated at'"
    )
