...
class PIRQueryBuilder:
    ...
    def __init__(self, pir_client: PIRClient, 
                 index_mapping: Dict[str, Dict[str, int]]):
        """
    ...
    async def _execute_population_frequency(self, query: GenomicQuery) -> QueryResult:
        ...
        return QueryResult(
            ...
            metadata={
                ...
                'variants_queried': len(variant_list)
            },
    ...
    def build_variant_query(self, chromosome: str, position: int,
                          ref_allele: Optional[str] = None,
                          alt_allele: Optional[str] = None) -> GenomicQuery:
    ...
    def build_population_frequency_query(self, variants: List[Dict],
                                       population: str) -> GenomicQuery:
    ...
    async def query_clinical_variants(self, gene_list: List[str],
                                    significance_filter: Optional[str] = None) -> QueryResult:
        """
    ...
    def get_query_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'avg_computation_time_ms': total_computation_time / len(self.cache) if self.cache else 0,
            'index_mapping_stats': {
