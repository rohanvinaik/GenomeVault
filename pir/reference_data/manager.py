...
class ReferenceDataManager:
    ...
    def get_nodes_in_region(self, region: GenomicRegion, 
                          population: Optional[str] = None) -> List[PangenomeNode]:
        """
    ...
    def get_variant_annotation(self, chromosome: str, position: int,
                             ref_allele: str, alt_allele: str) -> Optional[VariantAnnotation]:
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        total_sequence_length = sum(
            len(node.sequence) for node in self.nodes.values()
        )
