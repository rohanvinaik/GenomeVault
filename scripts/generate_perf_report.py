...
class PerformanceReportGenerator:
    ...
    def analyze_hdc_performance(self, hdc_data: List[Dict]) -> Dict[str, Any]:
        ...
        if "benchmarks" in latest:
            ...
            if "encoding_throughput" in benchmarks:
                ...
                analysis["summary"]["encoding_ops_per_sec"] = clinical_perf.get("throughput_ops_per_sec", 0)
            ...
            if "binding_operations" in benchmarks:
                ...
                if best_binding:
                    ...
                    analysis["summary"]["binding_ops_per_sec"] = binding_data[best_binding]["throughput_ops_per_sec"]
    ...
    def _plot_memory_comparison(self, memory_data: Dict):
        ...
        for bar, kb in zip(bars1, memory_kb):
            ax1.text(bar.get_x() + bar.get_width()/2, bar.get_height() + 5,
                    f'{kb:.0f} KB', ha='center', va='bottom')
    ...
    def generate_summary_report(self, all_data: Dict[str, List[Dict]]) -> Dict[str, Any]:
        ...
        if all_data["pir"]:
            report["lanes"]["pir"] = {
                "summary": {"status": "Benchmarks available"}
            }
