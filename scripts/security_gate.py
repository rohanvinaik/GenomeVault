...
class SecurityGateConfig:
    ...
    # License compliance
    blocked_licenses: Set[str] = field(default_factory=lambda: {
...
class SecurityGateEvaluator:
    ...
    def _generate_recommendations(self) -> List[str]:
        ...
        critical_cves = [issue for issue in self.issues if issue.severity == "critical" and issue.cve_id]
        if critical_cves:
...
def main():
    ...
    parser.add_argument("--threshold", choices=["strict", "moderate", "permissive"], default="moderate", help="Security threshold level")
    ...
    parser.add_argument("--phi-threshold", choices=["zero", "low", "medium"], default="zero", help="PHI tolerance level")
