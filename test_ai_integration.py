...
from genomevault.api.gateway.config.ai_config import get_ai_settings, AIIntegrationSettings
...
def test_anthropic_integration():
    ...
    try:
        ...
        print(f"✓ Anthropic integration initialized")
...
def test_openai_integration():
    ...
    try:
        ...
        print(f"✓ OpenAI integration initialized")
...
async def test_prompt_building():
    ...
    print(f"✓ Generated variant analysis prompt")
    print(f"  - Prompt length: {len(prompt)} characters")
    print(f"  - Includes {len(variants)} variants")
    print(f"  - Analysis type: clinical")
    ...
    drug_prompt = anthropic._build_drug_interaction_prompt(
        pgx_markers,
        medications,
        None
    )
