...
def test_zk_proofs():
    ...
    try:
        ...
        variant_proof = prover.prove_variant(
            public_input={"variant_hash": variant_hash},
            private_input={"variant_data": variant_data},
        )
        ...
        training_proof = prover.prove_training(public_input={}, private_input={})
        ...
        clinical_proof = prover.prove_clinical(public_input={}, private_input={})
...
def test_hypervector_encoding():
    ...
    try:
        ...
        variant = {"chrom": "chr1", "pos": 12345, "ref": "A", "alt": "G", "impact": "HIGH"}
