...
from genomevault.zk_proofs.witness_cache import (
    LRUCache,
    WitnessCache,
    get_witness_cache,
    reset_witness_cache
...
def test_lru_cache():
    ...
    # Test LRU eviction
    cache.put("key4", "value4")  # Should evict key1 (least recently used after accessing key1, key2, key3)
...
def test_cache_warming():
    ...
    common_patterns = [
        ("variant_presence", {
            "public": {"variant_hash": "common1", "reference_hash": "ref", "commitment_root": "root"},
            "private": {"variant_data": {"chr": "chr1", "pos": 1}, "merkle_proof": [], "witness_randomness": "r1"}
        }),
        ("diabetes_risk_alert", {
            "public": {"glucose_threshold": 126, "risk_threshold": 0.75, "result_commitment": "commit"},
