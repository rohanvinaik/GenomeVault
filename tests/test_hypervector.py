...
class TestHypervectorEngine:
    ...
    def test_multi_resolution_encoding(self, encoder_10k, encoder_15k, encoder_20k, 
    ...
    def test_similarity_preservation(self, encoder_10k, sample_genomic_features):
        ...
        assert abs(orig_sim - hyper_sim) < 0.1, \
    ...
    @pytest.mark.parametrize("dimensions,expected_memory_kb", [
