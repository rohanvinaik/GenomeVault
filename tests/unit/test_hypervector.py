...
class TestGenomicEncoder:
    ...
    def test_variant_encoding(self, encoder):
    ...
    def test_different_variants_orthogonal(self, encoder):
    ...
    def test_genome_encoding(self, encoder):
        ...
        variants = [
            ...
            {"chromosome": "chr3", "position": 11111, "ref": "G", "alt": "A", "type": "SNP"},
        ]
...
class TestHypervectorBinder:
    ...
    def test_circular_convolution_binding(self, binder):
    ...
    def test_xor_binding(self, binder):
    ...
    def test_multi_bind(self, binder):
    ...
    def test_protected_binding(self, binder):
...
class TestMultiModalBinder:
    ...
    def test_modality_keys_orthogonal(self, binder):
    ...
    def test_bind_modalities(self, binder):
    ...
    def test_extract_modality(self, binder):
    ...
    def test_cross_modal_similarity(self, binder):
