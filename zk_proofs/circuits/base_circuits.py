...
class BaseCircuit(ABC):
    ...
    def add_constraint(self, a: FieldElement, b: FieldElement, c: FieldElement,
                      ql: int = 0, qr: int = 0, qo: int = 0, qm: int = 0, qc: int = 0):
        """
