...
class Prover:
    ...
    def _validate_inputs(self, circuit: Circuit, 
                        public_inputs: Dict, private_inputs: Dict):
    ...
    def _generate_proof_id(self, circuit_name: str, 
                          public_inputs: Dict) -> str:
    ...
    def _simulate_proof_generation(self, circuit: Circuit,
                                 public_inputs: Dict,
                                 private_inputs: Dict) -> bytes:
        """
    ...
    def _simulate_variant_proof(self, public_inputs: Dict, 
                              private_inputs: Dict) -> bytes:
    ...
    def _simulate_prs_proof(self, public_inputs: Dict,
                          private_inputs: Dict) -> bytes:
    ...
    def _simulate_diabetes_proof(self, public_inputs: Dict,
                               private_inputs: Dict) -> bytes:
    ...
    def _simulate_generic_proof(self, circuit: Circuit,
                              public_inputs: Dict) -> bytes:
    ...
    def generate_recursive_proof(self, proofs: List[Proof]) -> Proof:
        ...
        recursive_proof = self.generate_proof(
    ...
    def _validate_proof_format(self, proof: Proof) -> bool:
        ...
        return (
            proof.proof_data is not None and
            len(proof.proof_data) > 0 and
            proof.circuit_name and
            proof.public_inputs
        )
